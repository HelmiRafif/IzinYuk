...
<x-guest-layout>
    <style>@import url("https://cdnjs.cloudflare.com/ajax/libs/MaterialDesign-Webfont/5.3.45/css/materialdesignicons.min.css");</style>
        <div class="min-w-screen h-full flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 text-gray-700 rounded-3xl shadow-2xl w-full overflow-hidden" style="max-width:1000px">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" name="name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Jimmy Birkins" :value="old('name')" required>                        
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input id="email" type="email" name="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" :value="old('email')" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="password" name="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" required autocomplete="new-password">                        
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-center">                                
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <button type="submit" name="submit" class="block w-60 max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold transform hover:scale-105 transition ease-out duration-300">Daftar</button>                                
                                    </div>                                                               
                                </div>                                 
                            </div>
