        ...
        <section class="w-full h-full px-8 pt-32 xl:px-8 bg-gray-50">
            <div class="max-w-5xl mx-auto">
                <div class="flex flex-col items-center md:flex-row">
                    ...
                    <x-slot name="logo">
                        ...
                        <h2 class="text-2xl font-extrabold leading-none text-black sm:text-3xl md:text-5xl" id="">EIS</h2>
                        <p class="text-xl font-bold leading-none text-black sm:text-xl md:text-3xl" id="">Employee Information System</p>
                    </div>            
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="w-full pl-32">
                    <div class="relative z-10 h-full py-10 overflow-hidden border-b-2 rounded-lg shadow-2xl px-7 bg-light ml-3" id="">
                        <h3 class="mb-6 text-2xl font-medium text-center" id="">Masuk untuk mengajukan izin</h3>
